...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col relative">
      ...
      {(isAddingToCart || isCheckingOut || isRemovingFromCart || isUpdatingQuantity || isClearingCart) && (
          ...
          <div className="bg-card border border-border rounded-lg p-6 shadow-xl">
            <div className="flex items-center gap-3">
              ...
              <span className="text-foreground font-medium">
                ...
                {isRemovingFromCart && 'Removing from cart...'}
                {isUpdatingQuantity && 'Updating quantity...'}
                {isClearingCart && 'Clearing cart...'}
              </span>
            </div>
          </div>
        </div>
